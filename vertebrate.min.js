...
var self=this
void 0!==opts&&$.each(opts,function(k,v){"object"==typeof v?$.extend(self[k],v):self[k]=v})}return collection.prototype=Object.create(Vertebrate.Collection.prototype),collection.prototype.constructor=collection,collection}))}()
